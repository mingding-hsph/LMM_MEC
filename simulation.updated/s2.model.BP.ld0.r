...
write.csv(MRMV_model,"./results/table1/ld0.BP.egger.csv")
write.csv(MRMV_IVW_model,"./results/table1/ld0.BP.IVW.csv")
write.csv(MRMV_MEDIAN_model,"./results/table1/ld0.BP.MEDIAN.csv")
write.csv(MMR_2stage_model,"./results/table1/ld0.BP.LMM.MEC.csv")
write.csv(presso_model,"./results/table1/ld0.BP.presso.csv")

write.csv(IV_con_strength,"./results/table1/ld0.BP.IV_con.csv")
write.csv(IV_strength,"./results/table1/ld0.BP.IV.csv")
write.csv(incept_pvalue,"./results/table1/ld0.BP.incept.pvalue.csv")
