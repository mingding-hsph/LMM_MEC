...
write.csv(MRMV_model,"./results/table1/ld3.UBP.egger.csv")
write.csv(MRMV_IVW_model,"./results/table1/ld3.UBP.IVW.csv")
write.csv(MMR_2stage_model,"./results/table1/ld3.UBP.LMM.MEC.csv")

write.csv(IV_con_strength,"./results/table1/ld3.UBP.IV.con.csv")
write.csv(IV_strength,"./results/table1/ld3.UBP.IV.csv")
write.csv(incept_pvalue,"./results/table1/ld3.UBP.incept.pvalue.csv")
