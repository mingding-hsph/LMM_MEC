...
write.csv(MRMV_model,"./results/table1/ld3.BP.egger.csv")
write.csv(MRMV_IVW_model,"./results/table1/ld3.BP.IVW.csv")
write.csv(MMR_2stage_model,"./results/table1/ld3.BP.LMM.MEC.csv")

write.csv(IV_con_strength,"./results/table1/ld3.BP.IV.con.csv")
write.csv(IV_strength,"./results/table1/ld3.BP.IV.csv")
write.csv(incept_pvalue,"./results/table1/ld3.BP.incept.pvalue.csv")
