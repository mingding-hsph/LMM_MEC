...
write.csv(MRMV_model,"./results/table1/ld0.UBP.egger.csv")
write.csv(MRMV_IVW_model,"./results/table1/ld0.UBP.IVW.csv")
write.csv(MRMV_MEDIAN_model,"./results/table1/ld0.UBP.MEDIAN.csv")
write.csv(MMR_2stage_model,"./results/table1/ld0.UBP.LMM.MEC.csv")
write.csv(presso_model,"./results/table1/ld0.UBP.presso.csv")

write.csv(IV_con_strength,"./results/table1/ld0.UBP.IV_con.csv")
write.csv(IV_strength,"./results/table1/ld0.UBP.IV.csv")
write.csv(incept_pvalue,"./results/table1/ld0.UBP.incept.pvalue.csv")
