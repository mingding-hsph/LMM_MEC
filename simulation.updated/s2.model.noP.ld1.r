...
write.csv(MRMV_model,"./results/table1/ld1.noP.egger.csv")
write.csv(MRMV_IVW_model,"./results/table1/ld1.noP.IVW.csv")
write.csv(MMR_2stage_model,"./results/table1/ld1.noP.LMM.MEC.csv")

write.csv(IV_con_strength,"./results/table1/ld1.noP.IV.con.csv")
write.csv(IV_strength,"./results/table1/ld1.noP.IV.csv")
write.csv(incept_pvalue,"./results/table1/ld1.noP.incept.pvalue.csv")
